...
BOT_TOKEN = environ.get('BOT_TOKEN', "8190064252:AAGWaKsXu9VVm7Zj_IdqhSFlimZQTTx7NdI")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002638021400 -1002671899473 -1002607534796 -1002656224546 -1002603049651').split()]  # For Multiple Id Use One Space Between Each.
